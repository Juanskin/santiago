...
public class Editar_alumno extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //o primero es obtener el id
            int id;
            
            id = Integer.parseInt(request.getParameter("id"));
            System.out.println(id);
            //necesito saber a quien editar para mostrar los datos
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Tabla para actualizar los datos del Alumno</h1>");
            
            out.println("<form method='action='Editar2' name='editar'>"
                    + "<table>");
            out.println("<tr>"
                    + "<td></td>"
